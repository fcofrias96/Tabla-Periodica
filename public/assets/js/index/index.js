$(document).ready(function () {
  ...
  const array = [[1, 'H'], [2, 'He'],[3, 'Li'], [4, 'Be'], [5, 'B'], [6, 'C'], [7, 'N'], [8, 'O'], [9, 'F'], [10, 'Ne'], [11, 'Na'], [12, 'Mg'], [13, 'Al'], [14, 'Si'], [15, 'P'], [16, 'S'], [17, 'Cl'], [18, 'Ar'], [19, 'K'], [20, 'Ca'],
  ...
  [101, 'Md'], [102, 'No'], [103, 'Lr'], [104, 'Rf'], [105, 'Db'], [106, 'Sg'], [107, 'Bh'], [108, 'Hs'], [109, 'Mt'], [110, 'Ds'], [111, 'Rg'], [112, 'Cn'], [113, 'Nh'], [114, 'Fl'], [115, 'Mc'], [116, 'Lv'], [117, 'Ts'], [118, 'Og'], [119, 'La-Lu'], [120, 'Ac-Lr']];


  for (i = 0; i < 120; i++) {
    try{
      $("#" + array[i][0]).text(array[i][1]);
      $("#" + array[i][0]).parent().removeClass("bg-grey");
    }
   catch(Exception){
